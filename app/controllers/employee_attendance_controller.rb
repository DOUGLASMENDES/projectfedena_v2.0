class EmployeeAttendanceController < ApplicationController
  ...
  def add_leave_types
    ...
    if request.post? and @leave_type.save
      flash[:notice] = t('employee_attendance.leave_type_saved') 
  ...
  def edit_leave_types
    ...
    if request.post? and @leave_type.update_attributes(params[:leave_type])
      flash[:notice] = t('employee_attendance.leave_type_updated')
      redirect_to :action => "add_leave_types"
    end
  end
  ...
  def register
    ...
    if request.post?
      unless params[:employee_attendance].nil?
        ...
        flash[:notice]= t('employee_attendance.attendance_registered') 
  ...
  def leaves
    ...
    if request.post? and @leave_apply.save
      ...
      flash[:notice]= t('employee_attendance.leave_app_created')  
  ...
  def approve_leave
    ...
    flash[:notice]= t('employee_attendance.leave_approved', :employee_first_name => @applied_employee.first_name, :applied_leave_start_date => @applied_leave.start_date, :applied_leave_end_date => @applied_leave.end_date)   
  ...
  def deny_leave
    ...
    flash[:notice]= t('employee_attendance.leave_denied', :employee_first_name => @applied_employee.first_name, :applied_leave_start_date => @applied_leave.start_date, :applied_leave_end_date => @applied_leave.end_date) 
  ...
  def cancel_application
    ...
    flash[:notice] = t('employee_attendance.cancel_application')
